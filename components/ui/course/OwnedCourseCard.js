            ...
            <div className="flex-4">
              <div className="px-4 py-5 sm:px-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">
                  ...
                  <span className={`text-xs text-${stateColor}-700 bg-${stateColor}-200 rounded-full border p-2`}>
                    {course.state}
                  </span>
                </h3>
              ...
              <div className="border-t border-gray-200">
                <dl>
                  ...
                  <div className="bg-white px-4 py-5 sm:grid sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 break-words md:break-normal">
                      {course.proof}
                    </dd>
                  </div>
